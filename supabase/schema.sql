...
-- Handicaps: per league, player, game, with date range and day-of-week multipliers
-- day_multipliers: JSONB keys "0"-"6" (0=Sun, 1=Mon, ... 6=Sat). Value = multiplier (e.g. 0.75). Missing = 1.0.
